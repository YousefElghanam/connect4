...
/*   Updated: 2025/03/14 02:46:37 by bgebetsb         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	count_length(long long n, t_properties *properties)
{
...
static void	fill_recursive(long long n, t_properties *prop, char *str,
		int remaining)
{
	char	c;
...
char	*ft_itoa_printf(long long n, t_properties *properties)
{
	...
	if (allocated > num_length)
		ft_memset(nb_str + (properties->flags[1] * num_length), ' ', allocated
			- num_length);
	return (nb_str);
}
